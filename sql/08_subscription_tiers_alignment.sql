...
-- File: sql/08_subscription_tiers_alignment.sql
-- Description: Unifies Free, Pro, and Enterprise quotas, locks client-side tier
--              forging, and establishes automated billing cycle quota rollover.
-- ==============================================================================
...
DO $$ BEGIN
    -- Add monthly_scan_quota if missing
    IF NOT EXISTS (
    ...
    -- Add scans_used_this_month if missing
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
