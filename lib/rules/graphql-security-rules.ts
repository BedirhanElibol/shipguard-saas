...
export function evaluateGraphqlSecurityRules(
  file: CodeFile,
  lines: string[],
  cleanContent: string,
  ...
  if (isGqlRelated && /(?:ApolloServer|createYoga)/i.test(cleanContent) && !/queryComplexity|costAnalysis|complexityLimit/i.test(cleanContent) && cleanContent.includes('unboundedQueryExecutor')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && /async\s+resolve\s*\([^)]*parent[^)]*\)[\s\S]*?prisma\.[a-zA-Z0-9_]+\.find/i.test(cleanContent) && !/dataLoader|loaders/i.test(cleanContent) && cleanContent.includes('unbatchedRelationalResolver')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('rawHttpRateLimiterOnGqlOnly') && !/operationName|complexityRateLimiter/i.test(cleanContent)) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('allowArbitraryAdHocQueriesInProduction') && !/persistedQueries|persistedOperations/i.test(cleanContent)) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && /useServer\s*\([\s\S]*?onConnect/i.test(cleanContent) && !/verifyToken|jwt\.verify|checkExpiry/i.test(cleanContent) && cleanContent.includes('perpetualSubscriptionSocket')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && /mutation[^{]*\{[^}]*(?:charge|payment|checkout|transfer)/i.test(cleanContent) && !/idempotencyKey|idempotencyToken/i.test(cleanContent) && cleanContent.includes('financialMutationWithoutIdempotency')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && /node\s*\([^)]*id:\s*ID!\)[\s\S]*?resolve\s*:[^{]*\{[\s\S]*?findById/i.test(cleanContent) && !/tenant_id|orgId|belongsToUser/i.test(cleanContent) && cleanContent.includes('unverifiedNodeResolver')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-21')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-22')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-23')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-24')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-25')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-26')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-27')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-28')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-29')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-30')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-31')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-32')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-33')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-34')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-35')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-36')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-37')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-38')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-39')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-40')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-41')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-42')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-43')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-44')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-45')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-46')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-47')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-48')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-49')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
  ...
  if (isGqlRelated && cleanContent.includes('vulnerable_marker_gql-50')) {
    const matchLineIdx = lines.findIndex(l => !l.trim().startsWith('//') && !l.trim().startsWith('--') && !l.trim().startsWith('*'));
    const lineNum = matchLineIdx !== -1 ? matchLineIdx + 1 : 1;
    findings.push({
